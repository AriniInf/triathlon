...
<div class="container" style="background-color: #fff9f7">
  ...
  <ul class="nav nav-pills" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="pill" href="#form4">Participant 4</a>
    </li>
    <li class="nav-item">
  ...
  <div class="tab-content">
    ...
    <div id="form4" class="container tab-pane fade"><br>
        <div class="bs-example">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a href="#athlete4" class="nav-link active" data-toggle="tab">Athlete</a>
                </li>
                <li class="nav-item">
                    <a href="#official4" class="nav-link" data-toggle="tab">Official</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane fade show active" id="athlete4">
                        <div class="page-content">
                            <div class="form-v10-content">
                                <form class="form-detail" action="/post-register" method="post" id="myform">
                                    <a href="<?= base_url('') ?>"><img src="assets/img/prev1.png" alt="back" style="width:40px;height:40px;padding: 50px 0px 0px 50px"></a>
        ...
        <!--         (TAB BUAT OFFICIALL) -->
                <div class="tab-pane fade" id="official4">
                        <div class="form-v10-content">
                            <form class="form-detail" action="/post-register" method="post" id="myform">
                                <a href="<?= base_url('') ?>"><img src="assets/img/prev1.png" alt="back" style="width:40px;height:40px;padding: 50px 0px 0px 50px"></a>
                                <div class="form-left">
